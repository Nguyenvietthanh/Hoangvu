		...
		<div class="content p-4">
			...
			<div width="100%" style="text-align: right;">
				<a id="add-author" href="#"
					...
					data-target="#modalAdd"> <i class="fa fa-fw fa-plus"></i> Thêm Loại
					Tour
				</a>
			</div>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalCenterTitle">Thêm Loại Tour</h5>
					...
					<div class="modal-body">
						<div class="col-12">
							<label for="validationServer01">Thêm Loại Tour</label> <input
