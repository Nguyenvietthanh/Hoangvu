	...
	<div class="container">
		<div class="row text-xs-center text-sm-left text-md-left">
			...
			<div class="col-xs-12 col-sm-3 col-md-3">
				...
				<ul class="list-unstyled quick-links">
					<li><a href="javascript:void();"><i
							class="fa fa-angle-double-right"></i>Hướng dẫn đặt Tour</a></li>
					<li><a href="javascript:void();"><i
							class="fa fa-angle-double-right"></i>Phương thức thanh toán</a></li>
					<li><a href="javascript:void();"><i
							class="fa fa-angle-double-right"></i>Lưu ý đặt tour</a></li>
					<li><a href="javascript:void();"><i
							class="fa fa-angle-double-right"></i>Câu hỏi thường gặp</a></li>
					<li><a href="javascript:void();"><i
							class="fa fa-angle-double-right"></i>Chính sách đặt Tour</a></li>
				</ul>
			</div>
			<div class="col-xs-12 col-sm-3 col-md-3">
				<h5>TÀI KHOẢN</h5>
